...
class LikeMenuItem(InteractionBase):
    menu_item = models.ForeignKey(MenuItem, on_delete=models.CASCADE, related_name='like_menu_items')
...
class Notification(BaseModel):
    ...
    menu_item = models.ForeignKey(MenuItem, null=True, blank=True, on_delete=models.CASCADE)

    def __str__(self):
        return f"Notification for {self.user.username} at {self.sent_at}"

class Follow(InteractionBase):
    store = models.ForeignKey(Store, on_delete=models.CASCADE, related_name='follow')
